...
@description('Set capability to "EnableServerless" if required Cosmos sku is to be Serverless. If not will be enabled for multi region')
param cosmosCapabilities object
